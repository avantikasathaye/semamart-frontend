...
import SemamartLogo from '../assets/SemamartLogo.png'
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" className="appHeader">
        <Toolbar>
          ...
          <Image src={SemamartLogo} style={{width: "20%"}}/>
          ...
          <Button variant="contained" className='btn-sellOnSema'>Sell On SEMA</Button>
          <Box sx={{ flexGrow: 1 }} />
